      ...
      <div class="col">
        <div class="card shadow p-5">
          <div class="card-header border-0">
            <h3 class="mb-2">Kullanıcı Ekle</h3>
          </div>
            ...
            <div class="row justify-content-md-center">
              <div class="col-md-12">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-alternative" name="user_name" placeholder="Kullanıcı Adı">
                </div>
              </div>
              <div class="col-md-12">
                    ...
                    <div class="row p-2 mt-3" style="box-shadow: 0 1px 3px rgba(50, 50, 93, 0.15), 0 1px 0 rgba(0, 0, 0, 0.02);border-radius: 0.375rem;">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="custom-control custom-checkbox mt-3 mb-3">
                          <input class="custom-control-input" name="user_permissions[<?= $url ?>][<?= $key ?>]" id="<?= $menu['title'] . '.' .  $key ?>" value="1" type="checkbox">
